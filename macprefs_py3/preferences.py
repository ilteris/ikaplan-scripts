...
from config import get_preferences_backup_dir, get_preferences_dir, get_user, get_preference_excludes
...
def backup():
    ...
    copy_dir(source, dest, excludes=get_preference_excludes())
